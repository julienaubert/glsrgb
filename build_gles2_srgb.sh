...
gcc -I ${glad}/include -I ${glad_glx}/include -Wall -pedantic -g -o gles_srgb ${glad}/src/glad.o ${glad_glx}/src/glad_glx.o main.c gl_error.c gl_compile.c -lX11 -lGL -lGLU -ldl
